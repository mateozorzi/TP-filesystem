...
obj/user/faultread:     formato del fichero elf32-i386
...
00800156 <printnum>:
  ...
  8001ea:	0f be 80 88 0e 80 00 	movsbl 0x800e88(%eax),%eax
  8001f1:	50                   	push   %eax
...
00800299 <vprintfmt>:
  ...
  800304:	ff 24 85 80 0f 80 00 	jmp    *0x800f80(,%eax,4)
  ...
  8003d2:	8b 14 85 e0 10 80 00 	mov    0x8010e0(,%eax,4),%edx
  8003d9:	85 d2                	test   %edx,%edx
  8003db:	74 15                	je     8003f2 <vprintfmt+0x159>
  8003dd:	52                   	push   %edx
  8003de:	68 a9 0e 80 00       	push   $0x800ea9
  8003e3:	56                   	push   %esi
  8003e4:	53                   	push   %ebx
  ...
  8003f2:	50                   	push   %eax
  8003f3:	68 a0 0e 80 00       	push   $0x800ea0
  8003f8:	56                   	push   %esi
  8003f9:	53                   	push   %ebx
  ...
  800414:	b8 99 0e 80 00       	mov    $0x800e99,%eax
...
008009bb <syscall>:
  ...
  8009f3:	68 3f 0f 80 00       	push   $0x800f3f
  8009f8:	6a 1e                	push   $0x1e
  8009fa:	68 5c 0f 80 00       	push   $0x800f5c
...
00800bb5 <_panic>:
  ...
  800bd1:	56                   	push   %esi
  800bd2:	50                   	push   %eax
  800bd3:	68 04 11 80 00       	push   $0x801104
  ...
  800be9:	c7 04 24 7c 0e 80 00 	movl   $0x800e7c,(%esp)
