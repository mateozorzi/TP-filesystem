...
obj/user/idle:     formato del fichero elf32-i386
...
00800033 <umain>:
  ...
  800040:	0e 80 00 
  800043:	e8 3a 01 00 00       	call   800182 <sys_yield>
...
008000a9 <syscall>:
  ...
  8000e1:	68 6f 0e 80 00       	push   $0x800e6f
  8000e6:	6a 1e                	push   $0x1e
  8000e8:	68 8c 0e 80 00       	push   $0x800e8c
...
008002a3 <_panic>:
  ...
  8002bf:	56                   	push   %esi
  8002c0:	50                   	push   %eax
  8002c1:	68 54 0f 80 00       	push   $0x800f54
  ...
  8002d7:	c7 04 24 9a 0e 80 00 	movl   $0x800e9a,(%esp)
...
00800392 <printnum>:
  ...
  800426:	0f be 80 9c 0e 80 00 	movsbl 0x800e9c(%eax),%eax
  80042d:	50                   	push   %eax
...
008004d5 <vprintfmt>:
  ...
  800619:	52                   	push   %edx
  80061a:	68 bd 0e 80 00       	push   $0x800ebd
  80061f:	56                   	push   %esi
  800620:	53                   	push   %ebx
  ...
  80062e:	50                   	push   %eax
  80062f:	68 b4 0e 80 00       	push   $0x800eb4
  800634:	56                   	push   %esi
  800635:	53                   	push   %ebx
  ...
  800650:	b8 ad 0e 80 00       	mov    $0x800ead,%eax
